export default function MoveInCleaningContent() {
  return (
    <article className="prose prose-slate max-w-none prose-headings:font-bold prose-a:text-[#00a8bc]">
      ...
      <ul>
        <li>Inside all cabinets, drawers, and closets (when empty)</li>
        <li>Full bathroom sanitization including tubs, showers, and fixtures</li>
        <li>Kitchen deep clean: counters, sinks, appliance exteriors, and floors</li>
        <li>All floor types: tile, hardwood, laminate, and carpet vacuuming</li>
        <li>Interior window cleaning and sill dusting</li>
        <li>Light switch plates, door frames, and vent covers</li>
      </ul>
